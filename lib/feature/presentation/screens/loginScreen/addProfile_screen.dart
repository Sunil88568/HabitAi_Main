                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      AppButton(
                        ...
                        onTap: (){
                          context.pushNavigator(SignupSuccess());
                        },
      ...
      children: [
        ...
        Obx(
            ...
            prefixIcon: Padding(
              ...
              child: ImageView(url:AppImages.birthcake, size: 18, margin: 15.right + 12.left),
            ),
            hint: AppStrings.dateOfBirth,
            controller: TextEditingController(text: dateOfBirth.value.isNotNullEmpty ? dateOfBirth.value.yyyyMMdd.ddcMMcyyyy : ""),
            readOnly: true,
